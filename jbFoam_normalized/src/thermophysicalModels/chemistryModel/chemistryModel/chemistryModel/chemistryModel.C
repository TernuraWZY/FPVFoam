...
)
{
    ...
    forAll(rho, celli)
    {
        ...
        //-calculate flame index
        //-for GRI3.0
        //RI[celli]=(1+(RR_[6][celli]+RR_[16][celli])*RR_[4][celli]/(abs(RR_[6][celli]+RR_[16][celli])*abs(RR_[4][celli])+SMALL))/2;
        //-for DRM2.2
        //RI[celli]=(1+(RR_[6][celli]+RR_[14][celli])*RR_[4][celli]/(abs(RR_[6][celli]+RR_[14][celli])*abs(RR_[4][celli])+SMALL))/2
    }
