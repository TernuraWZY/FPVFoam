...
void Foam::heRhoThermo<BasicPsiThermo, MixtureType>::calculate()
{
    ...
    forAll(TCells, celli)
    {
        ...
        //Info<< "is there? 4" << endl;
        muCells[celli] = mixture_.mu(pCells[celli], TCells[celli]);
        alphaCells[celli] = mixture_.alphah(pCells[celli], TCells[celli]);
        //Info<< "is there?" << endl;
    }
    Info<< "cell sucess" << endl;
    ...
    forAll(this->T_.boundaryField(), patchi)
    {
        ...
        forAll(pT, facei)
        {
            ...
            /*Info<< "pT[facei]" << pT[facei] << endl;
            Info<< "ppsi[facei]" << ppsi[facei] << endl;
            Info<< "prho[facei]" << prho[facei] << endl;
            Info<< "pmu[facei]" << pmu[facei] << endl;
            Info<< "palpha[facei]" << palpha[facei] << endl;*/     
            ...
            Info<< "pmu[facei]" << pmu[facei] << endl;
            Info<< "palpha[facei]" << palpha[facei] << endl;
            Info<< "is there?  2" << endl;*/
         }
    }
    Info<< "patchi sucess" << endl;
}
