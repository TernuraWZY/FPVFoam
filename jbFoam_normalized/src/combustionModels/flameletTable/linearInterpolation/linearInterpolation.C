...
inline scalar linearInterpolation::PVcorrect(const List<int>& ub, const scalarList& pos) const
{
   //return PVcorrect for correct max of PV
    scalar f0=0;
    if(pos[2]!=0)
       if(tableValues_[ub[0]][ub[1]][ub[2]]==0) f0=0;
       else f0=1;
    else f0=2;
    return f0;
}
